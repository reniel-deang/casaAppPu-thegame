...
@onready var worlds: Array = [$World_icon, $World_icon2, $World_icon3, $World_icon4, $World_icon5, $World_icon6]
var current_world: int = 0
var unlocked_levels: int = Global.current_level  # Tracks how many levels are unlocked
...
func _load_level(level: int) -> void:
	var scene_paths = [
		"res://scenes/Cutscenes/TransitionCutscenes/welcome.tscn",
		"res://scenes/Cutscenes/TransitionCutscenes/transition_1.tscn",
		"res://scenes/Cutscenes/TransitionCutscenes/transition_2.tscn",
		"res://scenes/Cutscenes/TransitionCutscenes/welcome_2.tscn",
		"res://scenes/Cutscenes/TransitionCutscenes/transition_3.tscn",
		"res://scenes/Cutscenes/TransitionCutscenes/transition_4.tscn"
	]
